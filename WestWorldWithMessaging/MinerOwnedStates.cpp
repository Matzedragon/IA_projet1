...
bool QuenchThirst::OnMessage(Miner* pMiner, const Telegram& msg)
{
    ...
    case Msg_GoingToToilet:
        ...
        cout << "\n" << GetNameOfEntity(pMiner->ID())
            << ": This stool seems free !";

        pMiner->GetFSM()->ChangeState(sitAtTheBar::Instance());
...
sitAtTheBar* sitAtTheBar::Instance()
{
    static sitAtTheBar instance;

    return &instance;
}

void sitAtTheBar::Enter(Miner* pMiner)
{
    cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "*sitting at the bar*";
}

void sitAtTheBar::Execute(Miner* pMiner)
{
    cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Damn this is some good beer";

}

void sitAtTheBar::Exit(Miner* pMiner)
{
    // TODO leaving the bar state
    cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "*getting up*";
}


bool sitAtTheBar::OnMessage(Miner* pMiner, const Telegram& msg)
{
    switch (msg.Msg)
    {
    ...
    case Msg_altercation:
        ...
        pMiner->GetFSM()->ChangeState(altercationWithDrunkard::Instance());
        return true;
    }//end switch
    return false;
}
...
//------------------------------------------------------------------------altercationWithDrunkard

altercationWithDrunkard* altercationWithDrunkard::Instance()
{
    static altercationWithDrunkard instance;
