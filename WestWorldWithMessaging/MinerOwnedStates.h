...
class sitAtTheBar : public State<Miner> {

private:
	sitAtTheBar() {};

	sitAtTheBar(const sitAtTheBar&);
	sitAtTheBar& operator=(const sitAtTheBar&);
...
class altercationWithDrunkard : public State<Miner> {

private:
	altercationWithDrunkard() {};

	altercationWithDrunkard(const altercationWithDrunkard&);
	altercationWithDrunkard& operator=(const altercationWithDrunkard&);
